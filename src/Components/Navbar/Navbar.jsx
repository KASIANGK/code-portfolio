...
function Navbar() {
  ...
  const handleToggle = () => {
    ...
    if (newIsDay) {
      ...
      gsap.to("#night", 1, { ease: Power1.easeInOut });
      gsap.to("#background", 1, {  ease: Power1.easeInOut });
    } else {
        ...
        <li>
          <div className="body">
            ...
            <div id="background"></div>
              ...
              <svg version="1.1" id="darkmode" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
              width="180px" height="171.667px" viewBox="0 0 369 171.667" enableBackground="new 0 0 369 171.667" xmlSpace="preserve">
              <g>
              <polygon className="star" id="star-1" fill="#A2B5BF" points="166.253,132.982 164.364,135.676 160.983,136.488 163.196,138.965 162.996,142.16 
                  166.253,140.998 169.509,142.16 169.309,138.965 171.522,136.488 168.142,135.676  "/>
              <polygon className="star" id="star-2" fill="#A2B5BF" points="175.522,44.243 172.684,48.29 167.603,49.51 170.929,53.233 170.628,58.035 
                  175.522,56.288 180.417,58.035 180.116,53.233 183.442,49.51 178.361,48.29  "/>
              <polygon className="star" id="star-3" fill="#A2B5BF" points="208.22,91.845 206.083,94.891 202.259,95.81 204.763,98.61 204.535,102.226 
                  208.22,100.911 211.903,102.226 211.677,98.61 214.181,95.81 210.356,94.891   "/>
              <polygon className="star" id="star-4" fill="#A2B5BF" points="252.545,39.052 250.409,42.098 246.585,43.017 249.089,45.819 248.86,49.433 
                  252.545,48.118 256.229,49.433 256.002,45.819 258.506,43.017 254.682,42.098  "/>
              <polygon className="star" id="star-5" fill="#A2B5BF" points="280.151,84.949 282.749,88.997 287.401,90.217 284.355,93.94 284.632,98.742 
                  280.151,96.995 275.669,98.742 275.946,93.94 272.899,90.217 277.552,88.997   "/>
              <polygon className="star" id="star-6" fill="#A2B5BF" points="249.791,124.466 246.668,128.919 241.076,130.261 244.737,134.356 244.405,139.64 
              ...
              <path id="cloud" fill="#ECF0F1" stroke="#CAD4D8" strokeWidth="6" strokeMiterlimit="10" d="M153.269,109.614h2.813
